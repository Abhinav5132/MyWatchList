...
use crate::frontend::{
    manage_user_profile::choose_image,
    popup_edit_list::{EditList, WatchListType},
};
...
pub fn ListsPgFn(user_id: i64) -> Element {
    ...
    let mut all_list = use_signal(|| AllListSimple { list: vec![] });
                        ...
                        div {
                            ...
                            div {
                                ...
                                button {
                                    ...
                                    onclick: move |_| {
                                        show_delete_popup.set((true, li.id));
                                    },
                                    img {
                                        class:"Feeling_icon",
                                        src: TRAHSH
...
#[component]
pub fn list_delete_pop_up(on_close: EventHandler, list_id: i64) -> Element {
...
#[component]
pub fn show_add_new_list(on_close: EventHandler) -> Element {
                    ...
                    div {
                        ...
                        button {
                            ...
                            onclick: move |_| {
                                ...
                                let is_user_image = *is_user_image.read();
                                let name = name.read().to_string();
                                let description = description.read().to_string();
                                let privacy_type = privacy.read().string();
                                let image = image.read().to_string();
                                let is_ranked = *is_ranked.read();
                                spawn(async move {
