...
pub fn ManageAccount() -> Element {
    ...
    let mut submit_username = {
        ...
        let mut refetch_title = refetch_title;
        ...
        move || {
            ...
            spawn(async move {
                ...
                if let Ok(_res) = client
                    ...
                    .json(&ChangeUsername { user_name: name })
        ...
        move || {
            ...
            spawn(async move {
                ...
                if let Ok(_res) = client
                    ...
                    .json(&ChangeEmail { email: user_email })
                    .bearer_auth(TOKEN.read())
                    .send()
                    .await
                {
    ...
    let verify_current_pwd = {
        let current_pwd = current_pwd;

        move || {
            spawn(async move {
                let username = username.read().to_string();
                let password = current_pwd.read().to_string();
                let client = Client::new();
        ...
        move || {
            ...
            spawn(async move {
                ...
                if let Ok(res) = client
                    ...
                    .json(&ChangePassword { pwd: password })
                    .bearer_auth(TOKEN.read())
                    .send()
                    .await
                {
...
pub async fn choose_image() -> Option<String> {
    let new_image = AsyncFileDialog::new()
